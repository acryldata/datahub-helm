...
| datahub-frontend.image.tag | string | `"v0.8.13"` | Image tag for datahub-frontend |
...
| elasticsearchSetupJob.image.tag | string | `"v0.8.13"` | Image repository for elasticsearchSetupJob |
...
| kafkaSetupJob.image.tag | string | `"v0.8.13"` | Image repository for kafkaSetupJob |
