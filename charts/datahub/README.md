...
| datahub-gms.sql.datasource.host | string | `"prerequisites-mysql:3306"` | SQL database host (with port) for GMS (overrides global value) |
| datahub-gms.sql.datasource.url | string | `"jdbc:mysql://prerequisites-mysql:3306/datahub?verifyServerCertificate=false\u0026useSSL=true"` | URL to access SQL database for GMS (overrides global value) |
| datahub-gms.sql.datasource.driver | string | `"com.mysql.cj.jdbc.Driver"` | SQL database Driver for GMS (overrides global value) |
