...
| datahub-frontend.image.tag | string | `"v0.8.33"` | Image tag for datahub-frontend |
...
| elasticsearchSetupJob.image.tag | string | `"v0.8.33"` | Image repository for elasticsearchSetupJob |
...
| kafkaSetupJob.image.tag | string | `"v0.8.33"` | Image repository for kafkaSetupJob |
...
| mysqlSetupJob.image.tag | string | `"v0.8.33"` | Image repository for mysqlSetupJob |
...
| postgresqlSetupJob.image.tag | string | `"v0.8.33"` | Image repository for postgresqlSetupJob |
...
| global.datahub.managed_ingestion.defaultCliVersion | string | `0.8.33` | This is the version of the DataHub CLI to use for UI ingestion, by default. |
