...
| datahub-frontend.image.tag | string | `"v0.8.18"` | Image tag for datahub-frontend |
...
| elasticsearchSetupJob.image.tag | string | `"v0.8.18"` | Image repository for elasticsearchSetupJob |
...
| kafkaSetupJob.image.tag | string | `"v0.8.18"` | Image repository for kafkaSetupJob |
...
| mysqlSetupJob.image.tag | string | `"v0.8.18.0"` | Image repository for mysqlSetupJob |
