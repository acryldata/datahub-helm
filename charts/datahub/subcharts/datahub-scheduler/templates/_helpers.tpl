...
*/}}
{{- define "datahub-scheduler.fullname" -}}
...
*/}}
{{- define "datahub-scheduler.chart" -}}
...
Common labels
*/}}
{{- define "datahub-scheduler.labels" -}}
helm.sh/chart: {{ include "datahub-scheduler.chart" . }}
{{ include "datahub-scheduler.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "datahub-scheduler.selectorLabels" -}}
app.kubernetes.io/name: {{ include "datahub-scheduler.name" . }}
...
*/}}
{{- define "datahub-scheduler.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (include "datahub-scheduler.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
